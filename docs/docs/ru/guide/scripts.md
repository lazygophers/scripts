...
| `delete_branch` | Удалить локальную ветку (один/пакет) | `delete_branch <name> [--force] [-y]` |
| `delete_branch_remote` | Удалить удалённую ветку (один/пакет) | `delete_branch_remote <name> [--remote <r>] [-y]` |
