...
│   ├── merge_canary, merge_develop, merge_master, merge_test   # 调 lib git_workflow.merge_to(target)
│   ├── push_canary, push_develop, push_master, push_test       # 单仓 push_to / 非 git 目录自动批量
